...
" explicitly tell vim where ruby 2.4 is so ruby works without system ruby
" needing to be 2.4.
"set rubydll=/usr/local/Cellar/ruby/2.4.3_1/lib/libruby.dylib
set rubydll=/usr/local/Cellar/ruby/2.5.0/lib/libruby.2.5.dylib
...
set wildignore+=.git/*,*/node_modules/*,*/.cache/*,*/.sass-cache/*,*/cache/*,*/.bundle/*,tmp/*,log/*,*node_modules*,*.pyc,*.class,*.jar,*.gif,*.png,*.jpg
